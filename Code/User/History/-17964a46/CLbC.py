...
test_case = input()
test_case_list = ["character_creation","character_levelup","combat_basic","class_specific_attacks","","polymorphic_behavior_test","stress_test","comprehensive_validation",]
