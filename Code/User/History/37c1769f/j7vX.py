...
test_case_list = ["basic_beverage_test","all_beverages_test","single_condiment_test","multiple_condiments_test","all_condiments_test","cost_calculation_test","decoration_order_test",
                  "complex_order_test","double_condiment_test","beverage_comparison_test","condiment_cost_test","cheapest_most_expensive_test" ,
                  "nested_decoration_test", "cost_breakdown_test", "description_format_test"
                  ]
for test in test_case_list:
    ...
    elif test_case == "complex_order_test": #"double_condiment_test":# "beverage_comparison_test": # "condiment_cost_test": #"cheapest_most_expensive_test": # "nested_decoration_test": #"cost_breakdown_test": #description_format_test
    ...
    elif test_case == "double_condiment_test":# "beverage_comparison_test": # "condiment_cost_test": #"cheapest_most_expensive_test": # "nested_decoration_test": #"cost_breakdown_test": #description_format_test
    ...
    elif test_case == "beverage_comparison_test": # "condiment_cost_test": #"cheapest_most_expensive_test": # "nested_decoration_test": #"cost_breakdown_test": #description_format_test
    ...
    elif test_case == "condiment_cost_test": #"cheapest_most_expensive_test": # "nested_decoration_test": #"cost_breakdown_test": #description_format_test
    ...
    elif test_case == "cheapest_most_expensive_test": # "nested_decoration_test": #"cost_breakdown_test": #description_format_test
    ...
    elif test_case == "nested_decoration_test": #"cost_breakdown_test": #description_format_test
    ...
    elif test_case == "cost_breakdown_test": #description_format_test
